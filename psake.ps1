Properties {
    ...
    $PSCoreMSI = "https://github.com/PowerShell/PowerShell/releases/download/v6.0.2/PowerShell-6.0.2-win-x64.msi"
    $PSCoreInstallPath = "C:\Program Files\PowerShell\6.0.2"
}
